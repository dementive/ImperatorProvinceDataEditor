...
class CTkTitleMenu(customtkinter.CTkToplevel):
    ...
    def add_cascade(self, text=None, **kwargs):
        ...
        self.menu_button = customtkinter.CTkButton(
            self, text=text, fg_color=fg_color, text_color=text_color, width=self.width, height=10, **kwargs
        )
    ...
    def change_header_color(self, caption_color):
        try:
            ...
            windll.dwmapi.DwmSetWindowAttribute(
                HWND, DWMWA_CAPTION_COLOR, byref(c_int(caption_color)), sizeof(c_int)
            )
        except:
            None
